...
class MarketCondition:
    ...
    def calc_market_condition(self,
        ...
        self.df.loc[
            ...
            (
              (self.df['close'].shift(-30) > self.df[f'recent_low_{trailing_recent_low_days}_days'] * (1 + above_recent_low_pct)) &
              (self.df['close'].shift(-60) > self.df[f'recent_low_{trailing_recent_low_days}_days'] * (1 + above_recent_low_pct))
            ),
